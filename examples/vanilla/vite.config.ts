...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@embedpdf/plugin-navigation': path.resolve(
        __dirname,
        '../../packages/plugin-navigation/src',
      ),
      ...
      '@embedpdf/plugin-page-manager': path.resolve(
        __dirname,
        '../../packages/plugin-page-manager/src',
      ),
      ...
      '@embedpdf/layer-render-partial': path.resolve(
        __dirname,
        '../../packages/layer-render-partial/src',
      ),
      '@embedpdf/layer-search': path.resolve(__dirname, '../../packages/layer-search/src'),
    },
  },
  server: {
    port: 3000,
    open: true,
    allowedHosts: ['test.pdfhosting.com'],
  },
});
