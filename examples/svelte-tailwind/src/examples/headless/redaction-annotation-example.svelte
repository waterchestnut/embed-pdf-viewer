<script lang="ts">
  ...
  import RedactionAnnotationExampleContent from './redaction-annotation-example-content.svelte';
        ...
        <DocumentContent documentId={activeDocumentId}>
          {#snippet children(documentContent)}
            {#if documentContent.isLoaded}
              <RedactionAnnotationExampleContent documentId={activeDocumentId} />
            {/if}
          {/snippet}
        </DocumentContent>
      {/if}
