...
- [FPDF_LoadCustomDocument](/docs/pdfium/functions/document/fpdf-loadcustomdocument) - Load a PDF document using a custom file access mechanism
- [FPDF_CloseDocument](/docs/pdfium/functions/document/fpdf-closedocument) - Close a loaded PDF document
- [FPDF_GetLastError](/docs/pdfium/functions/utility/fpdf-getlasterror) - Get the error code for the last failed operation