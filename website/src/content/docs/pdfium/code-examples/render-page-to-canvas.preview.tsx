  ...
  return (
    <Preview title="Render PDF Page to Canvas">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <div className="flex border border-gray-300 rounded-md overflow-hidden">
            ...
            <div className="px-3 py-1 bg-white">
              {pageCount > 0 ? `Page ${pageIndex + 1} of ${pageCount}` : 'Loading...'}
            </div>
            <button
              onClick={goToNextPage}
              disabled={pageIndex === pageCount - 1 || isLoading || pageCount === 0}
          ...
          <button
            onClick={rotate}
            disabled={isLoading}
            className="px-3 py-1 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 disabled:opacity-50"
            title="Rotate 90°"
          >
            Rotate {rotation}°
          </button>
        ...
        {/* Canvas */}
        <div className="relative border border-gray-300 rounded-md overflow-auto max-h-[500px] p-4 bg-gray-100">
          {isLoading && (
