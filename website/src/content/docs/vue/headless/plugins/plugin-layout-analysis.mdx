...
<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/headless/layout-analysis-example.vue",
    "../../examples/vue-tailwind/src/examples/headless/layout-analysis-example-content.vue"
  ]}
>
