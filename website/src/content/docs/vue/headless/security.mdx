...
description: Understand how to handle PDF security, encryption, and permission overrides in your Vue application.
searchable: true
---
...
<CodeExample 
  codePaths={[
    "../../examples/vue-tailwind/src/examples/headless/security-example.vue"
  ]}
>
  <SecurityExample />
</CodeExample>
