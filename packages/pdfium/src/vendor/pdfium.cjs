...
var _EPDFPage_CreateFormField = Module['_EPDFPage_CreateFormField'] = createExportWrapper('EPDFPage_CreateFormField', 4);
...
var _EPDFAnnot_GetButtonExportValue = Module['_EPDFAnnot_GetButtonExportValue'] = createExportWrapper('EPDFAnnot_GetButtonExportValue', 3);
var _EPDFAnnot_GetFormFieldRawValue = Module['_EPDFAnnot_GetFormFieldRawValue'] = createExportWrapper('EPDFAnnot_GetFormFieldRawValue', 4);
var _EPDFAnnot_SetFormFieldValue = Module['_EPDFAnnot_SetFormFieldValue'] = createExportWrapper('EPDFAnnot_SetFormFieldValue', 3);
var _EPDFAnnot_SetFormFieldName = Module['_EPDFAnnot_SetFormFieldName'] = createExportWrapper('EPDFAnnot_SetFormFieldName', 3);
var _EPDFAnnot_GetFormFieldObjectNumber = Module['_EPDFAnnot_GetFormFieldObjectNumber'] = createExportWrapper('EPDFAnnot_GetFormFieldObjectNumber', 2);
var _EPDFAnnot_ShareFormField = Module['_EPDFAnnot_ShareFormField'] = createExportWrapper('EPDFAnnot_ShareFormField', 3);
...
var _EPDFAnnot_SetFormFieldOptions = Module['_EPDFAnnot_SetFormFieldOptions'] = createExportWrapper('EPDFAnnot_SetFormFieldOptions', 4);
