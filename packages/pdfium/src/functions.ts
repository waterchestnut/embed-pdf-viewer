...
export const functions = {
  ...
  PDFiumExt_GetFileWriterData: [["number","number","number"] as const, null] as const,
  ...
  FPDF_LoadCustomDocument: [["number","number"] as const, 'number'] as const,
  FPDF_LoadMemDocument: [["number","number","number"] as const, 'number'] as const,
  FPDF_GetPageSizeByIndexF: [["number","number","number"] as const, 'number'] as const,
  ...
  FPDFBitmap_FillRect: [["number","number","number","number","number","number"] as const, null] as const,
  ...
  FPDF_PageToDevice: [["number","number","number","number","number","number","number","number","number","number"] as const, null] as const,
  ...
  FPDFAnnot_GetColor: [["number","number","number","number","number","number"] as const, 'number'] as const,
  ...
  FPDFAnnot_GetLine: [["number","number","number"] as const, 'number'] as const,
