...
// The glue is a UMD module that sets `module.exports = createPdfium`
const createPdfium: typeof import('./pdfium').default =
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  require('./pdfium.cjs'); // ← explicit .js keeps Node resolutions simple
