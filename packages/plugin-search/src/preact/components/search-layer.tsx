...
export function SearchLayer({ pageIndex, scale, style, highlightColor = '#FFFF00', activeHighlightColor = '#FFBF00', ...props }: SearchLayoutProps) {
  ...
  return (<div style={{
    ...
    {pageResults.map(({ result, originalIndex }) => result.rects.map(rect => (
      <div style={{
        position: 'absolute',
